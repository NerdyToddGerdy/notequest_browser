...
export const HIRELING_ROSTERS: Record<CityCulture, HirelingDef[]> = {
  human: [
    ...
    { name: "Mercenary", cost: 30, hp: 14, equipmentText: "Club (1d6-2 damage)", abilityText: "None.", weaponFormula: "1d6-2" },
  ],
  elven: [
    { name: "Elf Ranger", cost: 30, hp: 11, equipmentText: "Saber (1d6 damage)", abilityText: "Ignores Travel Events.", weaponFormula: "1d6" },
    { name: "Elf Soldier", cost: 60, hp: 13, equipmentText: "Staff (1d6-2 damage)", abilityText: "Can cast 3 random Basic Spells.", weaponFormula: "1d6-2" },
  ],
  dwarven: [
    { name: "Dwarf Miner", cost: 40, hp: 15, equipmentText: "Pickaxe (1d6-1 damage)", abilityText: "To Find Secret Passages, roll two dice.", weaponFormula: "1d6-1" },
    { name: "Dwarf Soldier", cost: 50, hp: 16, equipmentText: "Axe (1d6+1 damage)", abilityText: "Deals +1 damage against Orcs and Goblins.", weaponFormula: "1d6+1" },
  ],
  gnome: [
  ...
  goblin: [
    ...
    { name: "Orc Soldier", cost: 50, hp: 17, equipmentText: "Gladio (1d6 damage)", abilityText: "None.", weaponFormula: "1d6" },
...
export const HUMAN_FORTRESS_HIRELINGS: HirelingDef[] = [
  ...
  { name: "Burglar", cost: 40, hp: 14, equipmentText: "Dagger (1d6-1 damage)", abilityText: "Open locks without wasting torches.", weaponFormula: "1d6-1" },
  { name: "Bodyguard", cost: 60, hp: 16, equipmentText: "Shortsword (1d6 damage)", abilityText: "None.", weaponFormula: "1d6" },
  // Minstrel's own Mandolin is deliberately not a weaponFormula -- its combat contribution is
  // already the flat +2 damage bonus to the player's own attacks (attackBonus(), issue #25), not a
  // swing of its own; giving it a second, separate attack would double-count the same ability.
  { name: "Minstrel", cost: 60, hp: 16, equipmentText: "Mandolin (Two-handed)", abilityText: "Can play music in combat (+2 damage)." },
  { name: "Rent Wizard", cost: 80, hp: 14, equipmentText: "Staff (1d6-1 damage)", abilityText: "Can cast 4 random Basic Spells.", weaponFormula: "1d6-1" },
  { name: "War Veteran", cost: 100, hp: 16, equipmentText: "Longsword (1d6+1 damage)", abilityText: "None.", weaponFormula: "1d6+1" },
];
