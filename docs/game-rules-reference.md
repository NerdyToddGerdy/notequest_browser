...
| 3   | Lightbugster | 16  | You start with 3 uses of the _Light_ spell.                                                  |
...
| 12  | Dragonkin    | 30  | You start with 3 uses of the _Fireball_ spell.                                               |
...
only the _Dungeon Boss_ table on the dungeon's page and nothing else (no Content or Monsters roll).
...
Entering a dungeon consumes 1 torch to light the way. Some actions, such as _Open Lock_ and _Find Secret
Passages_, take time and may consume more torches.
...
- **Keys and Doors**: If you find a key, you can open any door in the dungeon. Keys found in one dungeon
  do not open doors in another. The _Master Key_ opens any door in any dungeon.
...
Reward, Boss, Armor, and Weapon. All six basic dungeon types share the _same_ Segments and Secret
...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2   | A magic circle on the floor. (works as a Portal; see in the expansion).                                                                          |
| 3   | 3 Fungoid (4 HP; 2 Damage; Loot; Regeneration) — _(note: this row is listed under Monsters, see below; Room Content row 3 is "Bottomless pit.")_ |
| 4   | Torture Room with 1d6 Treasures.                                                                                                                 |
...
_(Note: "Ter tido uma armadura destruída" for Blacksmith is left in the original Portuguese in the
source PDF — it translates to "Have had an armor destroyed.")_
...
When taking a building, you can choose between _Attach to your Realm_ or _Loot the City_.
...
_Example_: You have two hirelings by your side and two orcs attack. Each orc deals 3 damage, making their
...
_Unique dungeon — once placed on the map it cannot appear again._
...
_(As printed, rows 3-4 read identically ("A Treasure...") and row 2 reads "There's nothing here."; row 5-6
both "You found a Narrow Tunnel." — transcribed exactly as shown in the book.)_
...
_Unique dungeon — once placed on the map it cannot appear again. Goes on for infinite levels._
